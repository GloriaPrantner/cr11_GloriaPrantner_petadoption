...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="row">
                <?php 
                $sql= "SELECT * FROM animal WHERE animal_age <= 8 && animal_type = 'small' or animal_type = 'large'";
                    ...
                    foreach($rows as $key=>$value){
                        ...
                        <div class='card scheda col-3'>
                            ...
                            <div class='card-body'>
                                ...
                                <p class='card-text'>" . $value['animal_description']. " and is ". $value['animal_age']. " years old. </p> 
                            </div>
                        </div>";
                    }
                }
